...
Stepping outside kube, [python-yq](https://kislyuk.github.io/yq/) has been [rewritten in rust](https://github.com/clux/whyq). Not a huge feat when you are just deferring to [jq](https://github.com/jqlang/jq) - it becomes [very simple](https://github.com/clux/whyq/blob/c6631590ebd170c5e09885a43cff476d6787e574/yq.rs#L1-L302) then - but it's a fun and [necessary](https://hachyderm.io/@clux/111031702227829219) project for me, and one that could not be solved with the strange [go rewrite](https://github.com/mikefarah/yq/issues/193).

<!-- Why not use the go version? With it's [~30k lines of duplication](https://github.com/mikefarah/yq/tree/master/pkg/yqlib), and [questionable new api](https://github.com/mikefarah/yq/issues/193), the only thing they did better than [python-yq](https://kislyuk.github.io/yq/) for me was portability. Unfortunately, [I needed that](https://hachyderm.io/@clux/111031702227829219). So thank you for your service `python-yq` 🫡 -->
